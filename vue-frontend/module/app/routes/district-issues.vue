    ...
    <CLayout>
        ...
        <el-page-header :title="pageTitle" :showSubmenu="screen.gt.sm">
          ...
          <template v-slot:side>
            ...
            <CCalendarDropdown
              ...
              :url="'/district-issue/' + $route.params.slug + '/$date'"
            />
      ...
      <template v-slot:default>
        ...
        <template v-if="$route.params.slug === 'all'">
          <div v-if="queries.issues.result" style="overflow:hidden;">
            <query-items-grid
                :itemProps="{
                linkToIssue: true
              }"
                ...
                :items="queries.issues.result.nodes.map(item => item.post)"
...
<script>
  ...
  export default {
    ...
    apollo: {
      ...
      issues: generateQueryInfo('issues', require('~module/entity/graphql/getTerms.gql'), {}, {}),
    },
    data() {
      return {
        page: {
