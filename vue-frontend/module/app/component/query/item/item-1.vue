    ...
    <div :class="elmContent.class" class="i-content">
      ...
      <div class="i-media">
        ...
        <q-btn
          ...
          v-if="formatInfo && elmFormat.enable"
        >
          <q-icon :name="formatInfo.icon" class="q-ml-sm" size="12px"/>
        </q-btn>

        <div class="i-thumb">
          <component v-bind="bindLink" style="display: block;">
        ...
        <div class="i-terms -style1 q-ma-md q-px-xs" v-if="termsCategory.length>0 && elmTerms.enable">
          ...
          <transition name="slide-fade">
            ...
            <div class="q-mt-xs" v-if="hover || !expandable">
              ...
              <component class="block q-px-md" v-bind="bindLink">
                ...
                <div class="i-meta flex items-center q-mt-sm">
