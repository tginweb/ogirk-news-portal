    ...
    <template v-slot:default>
          ...
          <div class="col-9" v-if="activeEntity">
            ...
            >
              <div class="q-px-lg">
                ...
                <template v-else>
                  ...
                  <div v-if="activeIrkipedia">
                    ...
                    <div class="">
                      ...
                      <div
                        v-html="activeIrkipedia.teaser.substring(0, 150) + '...'"
                      />
                ...
                <div class="flex q-mb-sm items-center q-mb-md q-mt-lg">

                  <div class="text-weight-bold text-grey-9">НОВОСТИ</div>

                  <div class="q-ml-auto">
                    <router-link :to="activeEntity.url" class="s-link text-accent">все новости</router-link>
                  </div>
      ...
      <template v-else>
        ...
        <div class="row q-col-gutter-sm">
          ...
          <div class="col-auto col-grow" v-else>
