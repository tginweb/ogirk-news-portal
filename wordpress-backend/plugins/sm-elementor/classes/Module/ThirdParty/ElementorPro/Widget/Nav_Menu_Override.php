...
namespace SM_Elementor\Module\ThirdParty\ElementorPro\Widget;
...
class Nav_Menu_Override extends \ElementorPro\Modules\NavMenu\Widgets\Nav_Menu {


    private function _get_available_menus() {
    ...
    protected function _register_controls() {
        ...
        $menus = $this->_get_available_menus();
        ...
        $this->add_control(
            'sub_menu_mode',
            [
                'label' => __( 'Is submenu', 'elementor-pro' ),
        ...
        $this->add_control(
            'sub_menu_direct_parent',
            [
                'label' => __( 'Submenu direct parent', 'elementor-pro' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'condition' => [
                    'sub_menu_mode' => 'yes',
        ...
        $this->add_control(
            'sub_menu_current_if_empty',
            [
                'label' => __( 'Submenu current if empty', 'elementor-pro' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
                'condition' => [
                    'sub_menu_mode' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementor-nav-menu--main .elementor-item path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'padding_top_vertical_menu_item',
            [
                'label' => __( 'Vertical Padding Top', 'elementor-pro' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
                ...
                'devices' => [ 'desktop', 'tablet' ],
                'selectors' => [
                    '{{WRAPPER}} .elementor-nav-menu--main .elementor-item' => 'padding-top: {{SIZE}}{{UNIT}};',
                ],
            ]
        );

        $this->add_responsive_control(
            'padding_bottom_vertical_menu_item',
            [
                'label' => __( 'Vertical Padding Bottom', 'elementor-pro' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
                ...
                'devices' => [ 'desktop', 'tablet' ],
                'selectors' => [
                    '{{WRAPPER}} .elementor-nav-menu--main .elementor-item' => 'padding-bottom: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
    ...
    protected function render() {
        ...
        $available_menus = $this->_get_available_menus();
        ...
        if ($settings['sub_menu_mode']=='yes')
        {
            $args['sub_menu'] = true;
            $args['sub_menu_direct_parent'] = $settings['sub_menu_direct_parent']=='yes';
            $args['sub_menu_current_if_empty'] = $settings['sub_menu_current_if_empty']=='yes';
        }
